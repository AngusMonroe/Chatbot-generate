...
parser.add_argument('--glove', default='models/glove/mixed_vec', help='path to glove txt')
...
train_loader = TextClassDataLoader(args.train, d_word_index, batch_size=args.batch_size)
val_loader = TextClassDataLoader(args.test, d_word_index, batch_size=args.batch_size)
